...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Đặt lại mật khẩu mới (dành cho bác sỹ)</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('doctors.postResetPassword') }}">
                            @csrf
                            ...
                            <div class="row mb-3">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-end">Mật khẩu
                                    mới</label>
