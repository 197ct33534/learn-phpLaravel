...
<head>
    ...
    <title> @yield('title') -Trang quảng trị</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.index') }}">
                ...
                <div class="sidebar-brand-text mx-3">DEV </div>
            </a>
            ...
            @can('groups')
                <li class="nav-item">
                    ...
                    <div id="collapseGroup" class="collapse" aria-labelledby="headingUtilities"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Sẵn sàng đằng xuất ?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Chọn nút Đằng xuất , hệ thống sẽ xóa phiên làm việc của bạn</div>
